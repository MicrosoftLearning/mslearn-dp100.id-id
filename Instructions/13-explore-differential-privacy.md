---
lab:
  title: Jelajahi privasi diferensial
ms.openlocfilehash: b0c369d3c6405fa3990596a738962115e6889ec2
ms.sourcegitcommit: 18f734eeb1031a9cb69c3b294632efd2e69324ac
ms.translationtype: HT
ms.contentlocale: id-ID
ms.lasthandoff: 11/17/2021
ms.locfileid: "145195802"
---
# <a name="explore-differential-privacy"></a>Jelajahi Privasi Diferensial

Seringkali, data yang digunakan untuk melatih model pembelajaran mesin berisi nilai sensitif yang harus dirahasiakan. Privasi diferensial adalah teknik di mana "kebisingan" ditambahkan ke data sedemikian rupa sehingga pengukuran statistik dan agregasi tetap konsisten dengan data sumber mentah, tetapi lebih sulit untuk mengidentifikasi nilai untuk pengamatan individu.
...
## <a name="use-smartnoise-to-explore-differential-privacy"></a>Gunakan SmartNoise untuk menjelajahi privasi diferensial

Dalam latihan ini, kode untuk mengeksplorasi privasi diferensial dengan SmartNoise disediakan di buku catatan.

1. Di beranda Jupyter, jelajahi folder **/users/*your-user-name*/mslearn-dp100** tempat Anda mengkloning repositori buku catatan, dan buka buku catatan **Jelajahi Privasi Diferensial** .
