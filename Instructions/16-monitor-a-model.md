...
ms.locfileid: "145195811"
---
# <a name="monitor-a-model"></a>Memantau Model

Saat Anda menerapkan model sebagai layanan, akan berguna untuk dapat melacak informasi tentang permintaan yang diprosesnya.

Pembelajaran Mesin Azure terintegrasi dengan Azure Application Insights untuk memungkinkan Anda mencatat data dari layanan yang disebarkan.
...
## <a name="use-application-insights-to-monitor-a-real-time-service"></a>Gunakan Application Insights untuk memantau layanan waktu nyata

Dalam latihan ini, kode untuk mengonfigurasi wawasan aplikasi untuk layanan prediktif yang disebarkan disediakan di buku catatan.

1. Di beranda Jupyter, jelajahi folder **/users/*your-user-name*/mslearn-dp100** tempat Anda mengkloning repositori buku catatan, dan buka buku catatan **Monitor Model**.
